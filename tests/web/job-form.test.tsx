...
describe('HomePage', () => {
  it('shows the problem input form with readable Chinese copy', async () => {
    ...
    expect(html).toContain('data-home-typography="product-editorial"');
    expect(html).toContain('data-home-visual-system="studio-shell"');
    expect(html).toContain('data-home-banner="studio-hero"');
    ...
    expect(html).toContain('data-design-mode="professional"');
    expect(html).toContain('data-ui-system="v2"');
    expect(html).toContain('@media (max-width: 960px)');
    expect(html).toContain('data-responsive-shell="desktop-sidebar"');
    expect(html).toContain('data-theme-toggle="mode-switch"');
    expect(html).toContain('\u4e13\u4e1a\u6a21\u5f0f');
    ...
    expect(html).toContain('data-home-callout="priority-focus"');
    expect(html).toContain('data-home-callout="roadmap-focus"');
    ...
    expect(html).toContain('LoveLearning AI Studio');
    expect(html).toContain('PRODUCT BETA');
    expect(html).toContain('lovelearning.ai / studio / dashboard');
    expect(html).toContain('\u4eca\u65e5\u91cd\u70b9\uff1a\u8ba9\u8001\u5e08\u5feb\u901f\u5f00\u59cb\u751f\u6210');
  ...
  it('shows the dashboard overview from the fixed SaaS sidebar', async () => {
    ...
    expect(html).toContain('data-dashboard-typography="product-editorial"');
    expect(html).toContain('data-home-panel="dashboard"');
    expect(html).toContain('data-dashboard-quick-actions="primary"');
